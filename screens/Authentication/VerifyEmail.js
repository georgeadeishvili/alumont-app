    ...
    <View style={styles.mainWrapper}>
      ...
      <View style={styles.descriptionStyle}>
        <Text style={styles.descriptionText}>
          Bitte gebe deine E-Mail ein damit wir dir einen Link zum zurucksetzen
          des Passworts senden konnen
        </Text>
      </View>
      ...
      <TouchableOpacity onPress={() => forgotPass()} style={styles.RegButton}>
